  ...
  return (
    <div id="services" className="overflow-hidden">
      ...
      <div className="pt-16">
        ...
        <div className="relative z-10 cards flex items-center justify-between -mt-36 lg:space-x-8 space-y-16 xl:px-24 flex-wrap lg:flex-nowrap ">
          <div className="card bg-white shadow-2xl mt-16 p-4 xl:w-96 xl:h-[22rem] rounded-xl">
            ...
            <div className="card-body">
              <h5 className="card-title text-xl font-semibold py-3">
                UI / UX Design
              </h5>
